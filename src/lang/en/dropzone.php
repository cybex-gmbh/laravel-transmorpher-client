...
return [
    ...
    'error' => 'Error',
    'max_dimensions_exceeded' => 'The media needs a width of max :maxWidth and height of max :maxHeight.',
    'max_file_size_exceeded' => 'File is too big ({{filesize}}MiB). Max filesize: {{maxFilesize}}MiB.',
    'min_dimensions_subceeded' => 'The media needs a width of at least :minWidth and height of at least :minHeight.',
