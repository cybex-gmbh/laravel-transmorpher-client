...
class TransmorpherServiceProvider extends ServiceProvider
{
    ...
    protected function registerRoutes()
    {
        ...
        Route::middleware('web')->group(function () {
            ...
            Route::get('transmorpher/{transmorpherMedia}/getOriginalDerivative/{version}/{transformations?}', [VersionManagement::class, 'getOriginal'])->name('transmorpherGetOriginalDerivative');
